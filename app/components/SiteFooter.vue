  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> 今日泷体不适 </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Tartaglia770",
  home: "https://homepage.todaylongtbs.top",
  email: "mailto:taki@todaylongtbs.top",
};
</script>
